...
export const HARNESS_SURFACE_MATRIX: Readonly<Record<string, HarnessSurfaceSpec>> = {
  ...
  grok: {
    ...
    expectedPaths: [
      ...
      "plugins/prism-generated-prism-harness-qa/skills/qa-sop/SKILL.md",
  ...
  pi: {
    ...
    expectedPaths: [
      ...
      "packages/prism-generated-prism-harness-qa/skills/qa-sop/SKILL.md",
  ...
  "claude-code": {
    ...
    expectedPaths: [
      ...
      "skills/prism-generated-prism-harness-qa/skills/qa-sop/SKILL.md",
