...
/** Cursor local-plugin ids collapse `_` so they stay kebab-case in `plugins/local/`. */
export const normalizeCursorGeneratedPluginNameSegment = (pluginName: string): string => {
...
export const generatedCursorPluginId = (pluginName: string): string =>
  `prism-generated-${normalizeCursorGeneratedPluginNameSegment(pluginName)}`;

export const renderCursorGeneratedPluginManifest = (options: {
  ...
  `${JSON.stringify(
    {
      ...
      description: `Generated by prism from ${options.sourcePluginName}.`,
      commands: "commands/",
      agents: "agents/",
      skills: "skills/",
    },
