...
export const HOOK_CAPABILITIES: Record<HarnessId, Record<HookEvent, HookEventSupport>> = {
  ...
  "codex-cli": {
    ...
    "tool.failure": { kind: "unsupported", note: "pending S2" },
    stop: { kind: "unsupported", note: "pending S2" },
    "subagent.start": { kind: "unsupported", note: "pending S2" },
    "subagent.stop": { kind: "unsupported", note: "pending S2" },
    "compact.before": { kind: "unsupported", note: "pending S2" },
    "compact.after": { kind: "unsupported", note: "pending S2" },
    notification: { kind: "unsupported", note: "pending S2" },
  },
  opencode: {
  ...
  grok: {
    "tool.before": { kind: "native", nativeEvent: "PreToolUse", controls: ["block"] },
    "tool.after": { kind: "native", nativeEvent: "PostToolUse", controls: [] },
    "prompt.submit": { kind: "unsupported", note: "pending S4" },
    "permission.request": {
      kind: "unsupported",
    ...
    "session.start": { kind: "native", nativeEvent: "SessionStart", controls: [] },
    "session.end": { kind: "native", nativeEvent: "SessionEnd", controls: [] },
    "tool.failure": { kind: "unsupported", note: "pending S4" },
    stop: { kind: "unsupported", note: "pending S4" },
    "subagent.start": { kind: "unsupported", note: "pending S4" },
    "subagent.stop": { kind: "unsupported", note: "pending S4" },
    "compact.before": { kind: "unsupported", note: "pending S4" },
    "compact.after": { kind: "unsupported", note: "pending S4" },
    notification: { kind: "unsupported", note: "pending S4" },
  },
  "factory-droid": {
    "tool.before": { kind: "native", nativeEvent: "PreToolUse", controls: ["block"] },
    "tool.after": { kind: "native", nativeEvent: "PostToolUse", controls: [] },
  ...
  hermes: {
    "tool.before": { kind: "unsupported", note: "pending S3" },
    "tool.after": { kind: "unsupported", note: "pending S3" },
    "prompt.submit": { kind: "unsupported", note: "pending S3" },
    "permission.request": { kind: "unsupported", note: "pending S3" },
    "session.start": { kind: "unsupported", note: "pending S3" },
    "session.end": { kind: "unsupported", note: "pending S3" },
    "tool.failure": { kind: "unsupported", note: "pending S3" },
    stop: { kind: "unsupported", note: "pending S3" },
    "subagent.start": { kind: "unsupported", note: "pending S3" },
    "subagent.stop": { kind: "unsupported", note: "pending S3" },
    "compact.before": { kind: "unsupported", note: "pending S3" },
    "compact.after": { kind: "unsupported", note: "pending S3" },
    notification: { kind: "unsupported", note: "pending S3" },
  },
};
