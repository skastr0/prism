...
export const HOOK_CAPABILITIES: Record<HarnessId, Record<HookEvent, HookEventSupport>> = {
  ...
  "amp-orb": {
    "tool.before": { kind: "unsupported", note: "amp-orb lowers skills only" },
    "tool.after": { kind: "unsupported", note: "amp-orb lowers skills only" },
    "prompt.submit": { kind: "unsupported", note: "amp-orb lowers skills only" },
    "permission.request": { kind: "unsupported", note: "amp-orb lowers skills only" },
    "session.start": { kind: "unsupported", note: "amp-orb lowers skills only" },
    "session.end": { kind: "unsupported", note: "amp-orb lowers skills only" },
  ...
  "amp-runner": {
    "tool.before": { kind: "unsupported", note: "amp-runner is workflow-worker only" },
    "tool.after": { kind: "unsupported", note: "amp-runner is workflow-worker only" },
    "prompt.submit": { kind: "unsupported", note: "amp-runner is workflow-worker only" },
    "permission.request": { kind: "unsupported", note: "amp-runner is workflow-worker only" },
    "session.start": { kind: "unsupported", note: "amp-runner is workflow-worker only" },
    "session.end": { kind: "unsupported", note: "amp-runner is workflow-worker only" },
    "tool.failure": { kind: "unsupported" },
    stop: { kind: "unsupported" },
    "subagent.start": { kind: "unsupported" },
    "subagent.stop": { kind: "unsupported" },
  ...
  cursor: {
    "tool.before": {
      ...
      nativeEvent: "preToolUse",
      controls: ["block"],
      note: "Cursor plugin hooks are command scripts in hooks.json, not an SDK. Block via permission deny / exit 2.",
    },
    "tool.after": { kind: "native", nativeEvent: "postToolUse", controls: [] },
    "prompt.submit": {
      kind: "native",
    ...
    "permission.request": {
      kind: "unsupported",
      note: "Cursor plugin hooks do not document PermissionRequest.",
    },
    "session.start": { kind: "native", nativeEvent: "sessionStart", controls: [] },
    "session.end": { kind: "native", nativeEvent: "sessionEnd", controls: [] },
    ...
    "compact.after": {
      kind: "unsupported",
      note: "Cursor documents preCompact only.",
    },
    notification: {
      kind: "unsupported",
      note: "Cursor plugin hooks have no notification event.",
    },
  },
  hermes: {
    "tool.before": {
