...
export interface HarnessConfig {
  ...
  // Rules configuration (null means prism does not manage a rules surface)
...
// directories. `targets.agents` is compile-relevant for structured
// `agents/*.agent.ts` sources. Source markdown agents are intentionally not an
// install artifact; harness markdown is generated by lowerers only.
...
// OpenCode typed frontmatter block used where prism models OpenCode-specific settings
